...
SECRET_KEY = 'django-insecure-w*vu2w4fv3ju8xn*k84b*kse85##yz-!1=)7$s^1*nrf#(0z(-'
...
SIMPLE_JWT = {
    ...
    'SIGNING_KEY': SECRET_KEY,                       # Your project's secret key
    'AUTH_HEADER_TYPES': ('Bearer',),                # Header types to use
}